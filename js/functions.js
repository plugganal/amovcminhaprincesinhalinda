...
function timeElapse(date) {
    ...
    // Ajustar o ano se ainda não chegou na data do aniversário este ano
    if (current.getMonth() < date.getMonth() || 
        (current.getMonth() == date.getMonth() && current.getDate() < date.getDate())) {
        years--;
    }

    var result = "<span class=\"digit\">" + years + "</span> Anos";
...
function adjustCodePosition() {
	$('#code').css("margin-top", ($("#garden").height() - $("#code").height()) / 2 - 250);
}